 ...
 * @brief OrdOS memory and string utils.
 * @version 0.1.0
 * @date 2025-08-13
 *
 ...
 * @return char* Pointer to the first occurr.ence of the character, or NULL if.
 * not
 */
char*
 ...
 * @param str String to search.
 * @param c Character to search for.
 * @return char* Pointer to the last occurrence of the character, or NULL if
 * not. found
 */
char*
