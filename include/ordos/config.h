...
#define ORDOS_MEM_GDT_DESC_CNT 6     /**< GDT count. */
...
#define ORDOS_TASK_SCHED_NAME_LENGTH                                           \
  0x10                            /**< Task sched name max                     \
                                     length.*/
#define ORDOS_TASK_SCHED_CNT 0x10 /**< Task sched max count. */
